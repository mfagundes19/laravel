                                    ...
                                    <tbody>
                                        @for ($i = 0; $i < $number_prevision; $i++)
                                            <tr>
                                                ...
                                                <td>
                                                    {!! Form::select('prev_product_type_id['.$i.']', \App\Models\ProductType::where('category_id','=', $prev_product_category_id[$i])->pluck('name','id'), '', ['placeholder' => '', 'id' => 'prev_product_type_id['.$i.']','class' => 'form-control','data-rule-required' => 'false','data-msg-required' => '* Campo Obrigatório']) !!}
                                                </td>
                                                <td>
                                                    {!! Form::text('prev_percentual['.$i.']', '', ['id' => 'prev_percentual['.$i.']','class' => 'form-control','data-mask-type' => 'percent','maxlength' => 6]) !!}
                                                </td>
