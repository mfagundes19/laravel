...
<div class="row">
    <div class="container-fluid">
        <div class="col-lg-12 box-form-container">
            {!! Form::open(['url' => url($route->module.'/'.$route->action),'id' => 'form-'.$route->module,'method' => 'POST','data-action' => url($route->module.'/save'),'data-view' => 'commercial/'.$route->module.'/edit']) !!}      
                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('payment_information',$payment_information ?? '', ['id' => 'payment_information','class' => 'form-control','placeholder' => 'Dados Bancários','rows' => 3]) !!}   
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
