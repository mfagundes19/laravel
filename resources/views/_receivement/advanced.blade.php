<div class="row">
    <div class="container-fluid">
        <div class="col-lg-12 box-form-container">
            ...
            <div class="col-lg-6">
                <div class="col-lg-12" style="padding-bottom: 10px; font-size: 14px;">
                    <i class="fa fa-chevron-right" aria-hidden="true"></i>&nbsp;&nbsp;Qualidade da Carga
                </div>
            ...
            <div class="col-lg-6">
                <div class="col-lg-12" style="padding-bottom: 10px; font-size: 14px;">
                    <i class="fa fa-chevron-right" aria-hidden="true"></i>&nbsp;&nbsp;Restrições
                </div>
                ...
                @endforeach
                <div class="col-lg-12" style="padding: 5px; padding-top: 10px; padding-left: 15px; border: solid 1px #CDCDCD; margin-top: 5px; background-color: #E9E9E9E;">
                    <input id="option-outher-restriction" type="checkbox">&nbsp;&nbsp;
                    <label for="option-outher-restriction">Outro</label>
                </div>
                <div class="col-lg-12" id="option-restriction" style="padding: 5px; padding-top: 10px; display: none;">
                    {!! Form::text('option-cargo-quality-text', $advanced_option_list['option-restriction'] ?? '', ['id' => 'option-cargo-quality-text','class' => 'form-control']) !!}
                </div>
            </div>
