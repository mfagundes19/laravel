...
<head>
    ...
    <link href="{{ asset('plugins/flatpickr/css/flatpickr.css') }}" rel="stylesheet">
    <script src="{{ asset('plugins/flatpickr/js/flatpickr.js') }}"></script>
    <script src="{{ asset('plugins/flatpickr/js/lang-pt.js') }}"></script>
                ...
                <li class="nav-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <div class="row col-lg-12" style="padding: 0px; padding-left: 15px; padding-top: 10px; padding-bottom: 10px;">
                            <div class="col-lg-6">
                                <button class="btn btn-default btn-sm btn-block bdr-all" data-action="{{ route('user/profile') }}" onclick="Application.onRedirect(this);">
                                    <span class="fa fa-user"></span>&nbsp;&nbsp;&nbsp;&nbsp;Perfil
                                </button>
                            </div>
                            <div class="col-lg-6">
                                <button class="btn btn-default btn-sm btn-block bdr-all" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
