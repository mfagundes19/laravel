                    ...
                    <div class="row col-lg-12">  
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('date_expected', $date_expected ?? '', ['id' => 'date_expected','class' => 'form-control','data-mask-type' => 'date','placeholder' => 'dd/mm/aaaa','data-rule-required' => 'true','data-msg-required' => '* Campo Obrigatório','autocomplete' => 'off','data-datepicker' => 'true']) !!}
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                {!! Form::label('Operação:') !!}:
                                {!! Form::select('operation_type_id', \App\Models\OperationType::where([['active',true]])->orderBy('name', 'asc')->pluck('name','id'), $operation_type_id ?? '', ['placeholder' => '', 'id' => 'operation_type_id','class' => 'form-control','data-rule-required' => 'true','data-msg-required' => '* Campo Obrigatório']) !!}
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('total_traded', $total_traded ?? '', ['id' => 'total_traded','class' => 'form-control disabled','data-mask-type' => 'money','maxlength' => 20]) !!}
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('total_quantity', $total_quantity ?? '', ['id' => 'total_quantity','class' => 'form-control disabled','data-mask-type' => 'float','maxlength' => 9]) !!}
                            </div>
                        </div>
                        <div class="col-lg-12">    
                            <div class="row">
                                            ...
                                            @foreach($upload_file as $k => $v)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <button type="button" class="btn btn-danger btn-sm" data-upload-id="{{$v['upload_id']}}" onclick="ReceiptPlan.onRemoveUpload(this);">
